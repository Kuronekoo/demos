...
//        String test0 = "{\"appid\":\"yuhgjkas\",\"nowtime\":1407828167547,\"openid\":\"maino_VstuFKop-UTHJ3conlL-IzVyWk\"}";
        String test0="o1yl_jqVhV1i_GTY0dormzWBVRQY";
        String testSc0 = DESedeSecret.getInstance(ENCRYPT_KEY0).getEncryptKey(test0);

//        String decryptKey = DESedeSecret.getInstance(ENCRYPT_KEY0).getDecryptKey(test0);
//
//
//
