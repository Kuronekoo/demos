 ...
 * 
 */
@WebServiceClient(name = "HelloWSImplService", targetNamespace = "http://api.demo.webservice.sc.cn/", wsdlLocation = "file:/C:/Users/Kuroneko/Desktop/HelloWS.wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWSIMPLSERVICE_QNAME = new QName("http://api.demo.webservice.sc.cn/", "HelloWSImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Users/Kuroneko/Desktop/HelloWS.wsdl");
    ...
    public HelloWSImpl getHelloWSImplPort() {
        return super.getPort(new QName("http://api.demo.webservice.sc.cn/", "HelloWSImplPort"), HelloWSImpl.class);
    }
    ...
    public HelloWSImpl getHelloWSImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://api.demo.webservice.sc.cn/", "HelloWSImplPort"), HelloWSImpl.class, features);
    }
